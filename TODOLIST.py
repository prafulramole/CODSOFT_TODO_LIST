...
if __name__ == "__main__" :
	gui = Tk()
	gui.configure(background = "violet")
	gui.title("Todo List")
	...
	Exit = Button(gui, text = "Exit", fg = "Black", bg = "yellow", command = exit)

	enterTask.grid(row = 0, column = 2,padx=(0, 0), pady=(10, 10))

	enterTaskField.grid(row = 1, column = 2, ipadx = 50,padx=(0, 0), pady=(10, 10))
						
	Submit.grid(row = 2, column = 2,padx=(0, 0), pady=(10, 10))
